...
const UTILITY_ASSET_ROOT = "/_utilities/coffee";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/coffee/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/coffee/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("coffee");
