...
export type { BrewFixerUI };
export type BrewFixerLocaleContent = ToolLocaleContent<BrewFixerUI>;
...
export const brewFixer: CoffeeToolEntry<BrewFixerUI> = {
  id: 'coffee-flavor-diagnosis-extraction-problems',
  icons: {
